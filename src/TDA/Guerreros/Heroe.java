...
public  class Heroe extends Guerrero{
    ...
    public Heroe(Animation animacion, int campos, int cantidadDeVida, int[] golpePorSegundo, int nivelDeAparicion, String nombre, int rango, int costo,Tablero tablero) {
